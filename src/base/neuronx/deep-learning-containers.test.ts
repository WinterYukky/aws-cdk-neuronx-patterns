...
describe("VllmInferenceNeuronxImage", () => {
  ...
  it("LATEST points to the highest SDK version", () => {
    expect(VllmInferenceNeuronxImage.LATEST.neuronSdkVersion).toBe("2.28.0");
  });
});
...
describe("PytorchTrainingNeuronxImage", () => {
  ...
  it("LATEST points to the highest SDK version", () => {
    expect(PytorchTrainingNeuronxImage.LATEST.neuronSdkVersion).toBe("2.28.0");
  });
});
